...
class GraphPropMatchingLayer(GraphPropLayer):
    ...
    def forward(self,
        ...
        """
        #print("sa:", node_states.shape, from_idx.shape, to_idx.shape)
        aggregated_messages = self._compute_aggregated_messages(
            node_states, from_idx, to_idx, edge_features=edge_features)
        #print("sb:", aggregated_messages.shape)
        #print("sa:", node_states.shape, from_idx.shape, to_idx.shape, edge_features.shape)
        cross_graph_attention = batch_block_pair_attention(
            node_states, graph_idx, n_graphs, similarity=similarity)
        #print("sc:", cross_graph_attention.shape)
        attention_input = node_states - cross_graph_attention
        #print("sa:", node_states.shape, cross_graph_attention.shape)
        #print("sa:", attention_input.shape, node_states.shape, cross_graph_attention.shape)
